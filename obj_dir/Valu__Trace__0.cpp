...
void Valu___024root__trace_chg_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+5,(vlSelf->alu__DOT__ALUop1),32);
    bufp->chgIData(oldp+6,(vlSelf->alu__DOT__ALUop2),32);
    bufp->chgCData(oldp+7,(vlSelf->alu__DOT__ALUctrl),3);
    bufp->chgIData(oldp+8,(vlSelf->alu__DOT__Result),32);
    bufp->chgBit(oldp+9,(vlSelf->alu__DOT__EQ));
}
