...
class TwCacheTestbench : public SyncTestbench
{
protected:
...
TEST_F(TwCacheTestbench, CacheHitTest)
{
    // rst_n the cache before the test
    top->rst_n = 1;
    runSimulation(1);
    top->rst_n = 0;
    runSimulation(1);
...
TEST_F(TwCacheTestbench, CacheMissTest)
{
    top->rst_n = 1;
    runSimulation(1);
    top->rst_n = 0;
...
TEST_F(TwCacheTestbench, ByteWriteReadTest)
{
...
TEST_F(TwCacheTestbench, CacheHitAndMissTest)
{
    top->rst_n = 1;
    runSimulation(1);
    top->rst_n = 0;
...
TEST_F(TwCacheTestbench, PerformanceCountersTest)
{
