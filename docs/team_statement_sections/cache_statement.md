...
We were able to fully implement the direct mapped cache and were proud of our work, and despite having a draft ready for the two-way cache, we didn't have time to integrate it fully. However white testing it, we realised it had potential to exhibit a reduction in conflict misses with a given test case. 
